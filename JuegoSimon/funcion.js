//Javascript de Juego Simon Dice
...
function colorCero() {
    conTiempo = setTimeout(function () {
        ...
        conTiempo = setTimeout(function () {
            boton[0].style.backgroundColor = "#FFFF00"
        }, 500)
    }, 500)
}
...
function colorUno() {
    conTiempo = setTimeout(function () {
        ...
        conTiempo = setTimeout(function () {
            boton[1].style.backgroundColor = "#0000FF"
        }, 500)
    }, 500)
}
...
function colorDos() {
    conTiempo = setTimeout(function () {
        ...
        conTiempo = setTimeout(function () {
            boton[2].style.backgroundColor = "#FF0000"
        }, 500)
    }, 500)
}
...
function colorTres() {
    conTiempo = setTimeout(function () {
        ...
        conTiempo = setTimeout(function () {
            boton[3].style.backgroundColor = "#008000"
        }, 500)
    }, 500)
}
...
function ordenarPorPuntos() {
    ...
    valoresEnRanking = valoresEnRanking.sort((a, b) => b.puntos - a.puntos)
...
function ordenarPorFecha() {
    ...
    lista.innerHTML = ""
    var valoresEnRanking = traerStorage()
    valoresEnRanking = valoresEnRanking.sort((a, b) => new Date(b.fecha).getTime() - new Date(a.fecha).getTime())
    for (i = 0; i < valoresEnRanking.length; i++) {
        var paraLista = "Nombre: " + valoresEnRanking[i].nombre + " Puntos: " + valoresEnRanking[i].puntos + " Fecha : " + valoresEnRanking[i].fecha
        lista.innerHTML += `<li>${paraLista}</li>`
    }
