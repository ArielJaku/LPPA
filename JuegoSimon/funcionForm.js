//JAVASCRIPT PARA FORMULARIO DE ENVIO DE CONSULTA
...
function validarNombre() {
    ...
    if (valor.length < 3) {
        ...
        //el nombre debe tener solo letras , numeros, hay un caracter que no debe existir")
        return false
    } else {
        //esta todo correcto, el nombre es solo alfanumerico
        return true
    }
}
...
function validarCorreo() {
    ...
    if (tieneArroba == -1) {
        //EL MAIL DEBE TENER ARROBA
        return false
    } else if (tienePunto == -1) {
        //EL MAIL DEBE TENER UN PUNTO COMO MINIMO
        return false
    } else if (tieneEspacio != -1) {
        //EL MAIL NO DEBE TENER ESPACIOS
        return false
    } else {
        //Mail es Correcto
        return true
